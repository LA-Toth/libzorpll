...
#Source0:		https://www.balabit.com/downloads/files/zorp/6.0.0/source/libzorpll_6.0.0.0.tar.gz
...
%if 0%{?fedora} || 0%{?rhel} || 0%{?centos}
rm %{buildroot}/usr/libexec/failure_notify6.0-0
%else
rm %{buildroot}/usr/lib/failure_notify6.0-0
%endif
